...
void Play_Pirates()
{
  for (int thisNote = 0; thisNote < (sizeof(Pirates_note)/sizeof(int)); thisNote++) {
    ...
    tone(10, Pirates_note[thisNote], noteDuration);
...
void Play_CrazyFrog()
{
  for (int thisNote = 0; thisNote < (sizeof(CrazyFrog_note)/sizeof(int)); thisNote++) {
    ...
    tone(10, CrazyFrog_note[thisNote], noteDuration);
...
void Play_MarioUW()
{
    ...
    tone(10, MarioUW_note[thisNote], noteDuration);
...
void Play_Titanic()
{
    ...
    tone(10, Titanic_note[thisNote], noteDuration);
