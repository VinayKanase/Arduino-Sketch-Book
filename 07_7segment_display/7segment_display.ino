...
int a=5; //definition digital 7  pins as pin to control 'a' section(segment)
int b=4; //definition digital 6  pins as pin to control 'b' section(segment)
int c=7; //definition digital 4  pins as pin to control 'c' section(segment)
int d=8;//definition digital 11 pins as pin to control 'd' section(segment)
int e=9;//definition digital 10 pins as pin to control 'e' section(segment)
int f=10; //definition digital 8  pins as pin to control 'f' section(segment)
int g=11; //definition digital 9  pins as pin to control 'g' section(segment)
int dp=6;//definition digital 5  pins as pin to control 'dp' section(segment)
